...
urlpatterns = [
    ...
    path("profile/mfa/totp/disable/", views.mfa_totp_disable_view, name="profile-mfa-totp-disable"),
    path("profile/mfa/totp/disable", views.mfa_totp_disable_view),
    path("profile/mfa/email/disable/", views.mfa_email_disable_view, name="profile-mfa-email-disable"),
    path("profile/mfa/email/disable", views.mfa_email_disable_view),
