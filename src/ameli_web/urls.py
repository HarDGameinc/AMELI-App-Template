...
urlpatterns = [
    ...
    path("admin/webhooks/", admin_views.admin_webhooks, name="admin-webhooks"),
    path("admin/webhooks/<int:endpoint_id>/revoke/", admin_views.admin_webhook_revoke, name="admin-webhook-revoke"),
    path("admin/webhooks/<int:endpoint_id>/deliveries/", admin_views.admin_webhook_deliveries, name="admin-webhook-deliveries"),
